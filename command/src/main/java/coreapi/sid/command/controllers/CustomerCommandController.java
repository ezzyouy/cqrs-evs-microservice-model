package coreapi.sid.command.controllers;
...
import org.sid.coreapi.dtos.CostumerRequestDTO;
...
public class CustomerCommandController {
    ...
    @PostMapping("/create")
    public CompletableFuture<String> newCostumer(@RequestBody CostumerRequestDTO request){
